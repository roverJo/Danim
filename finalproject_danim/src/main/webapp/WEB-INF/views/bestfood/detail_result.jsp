...
<form id="addLodgeForm" action="login_checkZimByLodge.do" method="get">
   ...
   // 주소로 좌표를 검색합니다
   geocoder.addr2coord("${requestScope.dList[0].bestFoodVO.shop_add }", function(status, result) {
       ...
       // 정상적으로 검색이 완료됐으면 
        if (status === daum.maps.services.Status.OK) {
           ...
           var infowindow = new daum.maps.InfoWindow({
               content: '<div style="width:150px;text-align:center;padding:6px 0;">${requestScope.dList[0].bestFoodVO.shopname }</div>'
           });
